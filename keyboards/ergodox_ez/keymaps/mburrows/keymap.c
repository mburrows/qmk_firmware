...
//  ,--------------------------------------------------.           ,--------------------------------------------------.
        GRV  ,   1  ,   2  ,   3  ,   4  ,   5  , LBRC ,             RBRC ,   6  ,   7  ,   8  ,   9  ,   0  ,  EQL   ,\
//  |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
...
// |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
       _____, _____, _____, _____, _____, _____,                           PLUS ,   4  ,   5  ,   6  , ASTR ,  EQL   ,\
// |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
       _____, _____, _____, _____, _____, _____, _____,             _____, MINS ,   1  ,   2  ,   3  , SLSH , _____  ,\
// `--------+------+------+------+------+-------------            `-------------+------+------+------+------+--------'
       _____, _____, _____, _____, _____,                                          DOT ,   0  ,  DOT , _____, _____,\
//   `----------------------------------'                                       `----------------------------------'
//                                        ,-------------.       ,-------------.
...
void matrix_scan_user(void) {
  LEADER_DICTIONARY() {
    ...
    SEQ_TWO_KEYS(KC_J, KC_2) {
      SEND_STRING("{issue:EUL2-}"SS_TAP(X_LEFT));
    }
